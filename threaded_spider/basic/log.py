...
from threaded_spider.basic.compat import unicode, _PY3
from threaded_spider.basic import context
from threaded_spider.basic import _reflect as reflect
from threaded_spider.basic import util
from threaded_spider.basic import failure
from threaded_spider.basic.threadable import synchronize
...
class FileLogObserver:
    ...
    def emit(self, eventDict):
        ...
        util.retry_when_interrupt(self.write, timeStr + " " + msgStr)
        util.retry_when_interrupt(self.flush)  # Hoorj!
...
class PythonLoggingObserver(object):
    ...
    def __init__(self, loggerName="threaded_spider"):
        """
